...
| --- | --- | --- | --- |
| [LPC Farm](https://opengameart.org/content/lpc-farm) by bluecarrot16, Wolthera van Hövell tot Westerflier (TheraHedwig), and Ivan Voirol | District buildings | `src/assets/lpc/farm` | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
| [Universal LPC Sprite Male 01](https://opengameart.org/content/universal-lpc-sprite-male-01) by Gaurav Munjal and Stephen Challener (Redshrike) | Animated explorer character | `src/assets/lpc/character` | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) |
